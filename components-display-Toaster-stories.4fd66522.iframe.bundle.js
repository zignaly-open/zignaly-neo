...
`,ToastContainer=styled_components_browser_esm.ZP.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: center;
  ...
  ${props=>"success"===props.variant&&styled_components_browser_esm.iv`
      ${Caption} {
  ...
  ${props=>"info"===props.variant&&styled_components_browser_esm.iv`
      ${Caption} {
  ...
  ${props=>"error"===props.variant&&styled_components_browser_esm.iv`
      ${Caption} {
      ...
      background: #321e46;
    `}
`;var Typography=__webpack_require__("./src/components/display/Typography/index.tsx");function _extends(){return _extends=Object.assign?Object.assign.bind():function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source)Object.prototype.hasOwnProperty.call(source,key)&&(target[key]=source[key])}return target},_extends.apply(this,arguments)}var SvgCheckIcon=function SvgCheckIcon(props){return react.createElement("svg",_extends({width:"1em",height:"1em",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},props),react.createElement("path",{d:"M17.6202 6.6083L9.4001 14.8284L6.37973 11.8081C6.23329 11.6616 5.99585 11.6616 5.84939 11.8081L4.96551 12.6919C4.81907 12.8384 4.81907 13.0758 4.96551 13.2223L9.13492 17.3917C9.28135 17.5381 9.51879 17.5381 9.66526 17.3917L19.0344 8.02252C19.1809 7.87608 19.1809 7.63865 19.0344 7.49218L18.1505 6.6083C18.0041 6.46186 17.7667 6.46186 17.6202 6.6083Z",fill:props.color}))},Info=__webpack_require__("./node_modules/@mui/icons-material/Info.js"),error_alert_icon=__webpack_require__("./src/assets/icons/error-alert-icon.svg"),dark=__webpack_require__("./src/theme/dark.ts"),jsx_runtime=__webpack_require__("../../node_modules/react/jsx-runtime.js");const Toaster=({variant="error",size="large",caption=""})=>(0,jsx_runtime.jsxs)(ToastContainer,{variant,size,children:[(0,jsx_runtime.jsxs)(IconContainer,{children:["error"===variant&&(0,jsx_runtime.jsx)(error_alert_icon.r,{color:dark.Z.redGraphOrError}),"success"===variant&&(0,jsx_runtime.jsx)(SvgCheckIcon,{color:dark.Z.greenGraph}),"info"===variant&&(0,jsx_runtime.jsx)(Info.Z,{fill:dark.Z.neutral600})]}),(0,jsx_runtime.jsx)(Caption,{children:(0,jsx_runtime.jsx)(Typography.Z,{variant:"large"===size?"body1":"body2",weight:"regular",children:caption})})]});Toaster.displayName="Toaster";const display_Toaster=Toaster;try{Toaster.displayName="Toaster",Toaster.__docgenInfo={description:"",displayName:"Toaster",props:{variant:{defaultValue:{value:"error"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"error"'},{value:'"info"'},{value:'"success"'}]}},size:{defaultValue:{value:"large"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"small"'},{value:'"large"'}]}},caption:{defaultValue:{value:""},description:"",name:"caption",required:!1,type:{name:"string | Element | undefined"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/display/Toaster/index.tsx#Toaster"]={docgenInfo:Toaster.__docgenInfo,name:"Toaster",path:"src/components/display/Toaster/index.tsx#Toaster"})}catch(__react_docgen_typescript_loader_error){}const stories={title:"Display/Toaster",component:display_Toaster,argTypes:{variant:{options:["success","error"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},caption:{control:"text"}},parameters:{jest:["test.tsx"]}},Template=args=>(0,jsx_runtime.jsx)(display_Toaster,{...args});Template.displayName="Template";const Success=Template.bind({});Success.args={caption:"Something went right",variant:"success"};const Error=Template.bind({});Error.args={caption:"Something went wrong",variant:"error"}},"./src/components/display/Typography/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Z:()=>display_Typography});__webpack_require__("../../node_modules/react/index.js");var styled_components_browser_esm=__webpack_require__("../../node_modules/styled-components/dist/styled-components.browser.esm.js"),styled=__webpack_require__("./src/utils/styled.ts");const Layout=styled_components_browser_esm.ZP.h1`

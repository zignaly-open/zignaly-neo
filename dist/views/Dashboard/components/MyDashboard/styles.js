...
export var Heading = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  margin-bottom: 64px;\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  margin-bottom: 64px;\n"])));
export var Inline = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  text-align: left;\n  padding: 0 22px;\n"], ["\n  text-align: left;\n  padding: 0 22px;\n"])));
export var ZigTableWrapper = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  td,\n  th {\n    &:first-of-type {\n      border-right: 1px solid ", ";\n    }\n  }\n"], ["\n  td,\n  th {\n    &:first-of-type {\n      border-right: 1px solid ", ";\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;

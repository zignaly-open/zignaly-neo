...
export var TypeText = styled(Typography)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  gap: 4px;\n\n  span:nth-of-type(1) {\n    color: ", ";\n  }\n\n  span:nth-of-type(2) {\n    color: ", ";\n  }\n"], ["\n  display: flex;\n  gap: 4px;\n\n  span:nth-of-type(1) {\n    color: ", ";\n  }\n\n  span:nth-of-type(2) {\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
export var Item = styled('div')(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  padding: 5px;\n  cursor: pointer;\n\n  & > :first-child {\n    margin-right: 12px;\n  }\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  padding: 5px;\n  cursor: pointer;\n\n  & > :first-child {\n    margin-right: 12px;\n  }\n"])));
export var InternalName = styled(Typography)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  text-overflow: ellipsis;\n  overflow: hidden;\n"], ["\n  text-overflow: ellipsis;\n  overflow: hidden;\n"])));

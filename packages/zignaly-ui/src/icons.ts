...
export { ReactComponent as ZigGlobeLanguagesIcon } from "assets/icons/globe-languages.svg";
...
export { ReactComponent as ZigClockAltIcon } from "assets/icons/clock-alt-icon.svg";

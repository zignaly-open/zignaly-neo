...
const { EtherIconStory } = composeStories(stories);
...
describe("components/display/ZigCoinIcon", () => {
  describe("stories", () => {
    it("should render", () => {
      ...
      const renderEtherCoin = render(<EtherIconStory />);
    ...
    it("should render placeholder icon if not found", () => {
      const renderEtherCoinWithFallBack = render(<EtherIconStory coin={"SCAQQFS"} />);

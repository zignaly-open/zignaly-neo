...
`,ZigNormalSelectGlobalStyle=(0,jsx_runtime.jsx)(GlobalStyles.Z,{styles:emotion_react_browser_esm.iv`
      .zig-react-select {
        &__menu {
          &-list {
    ...
    `}),ZigMediumSelectGlobalStyle=(0,jsx_runtime.jsx)(GlobalStyles.Z,{styles:emotion_react_browser_esm.iv`
      .zig-react-select {
        &__menu {
          &-list {
            ${NiceScrollbar.toString()};
